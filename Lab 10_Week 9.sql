...
from orders o inner join product_details pd 
on o.prod_id = pd.pro_id
inner join product p on p.pro_id = pd.prod_id
...
select c.* from CUSTOMER c left join orders o 
